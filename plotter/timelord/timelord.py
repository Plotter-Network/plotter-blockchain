...
from plottervdf import create_discriminant

from plotter.consensus.constants import ConsensusConstants
from plotter.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
...
from plotter.timelord.iters_from_block import iters_from_block
from plotter.timelord.timelord_state import LastState
from plotter.timelord.types import Chain, IterationType, StateType
from plotter.types.blockchain_format.classgroup import ClassgroupElement
from plotter.types.blockchain_format.reward_chain_block import RewardChainBlock
...
class Timelord:
    def __init__(self, root_path, config: Dict, constants: ConsensusConstants):
        ...
        self.server: Optional[PlotterServer] = None
