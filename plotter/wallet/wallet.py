...
from plotter.consensus.cost_calculator import calculate_cost_of_program, NPCResult
from plotter.full_node.bundle_tools import simple_solution_generator
from plotter.full_node.mempool_check_conditions import get_name_puzzle_conditions
from plotter.types.blockchain_format.coin import Coin
from plotter.types.blockchain_format.program import Program, SerializedProgram
from plotter.types.announcement import Announcement
...
from plotter.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import (
    DEFAULT_HIDDEN_PUZZLE_HASH,
    calculate_synthetic_secret_key,
    puzzle_for_pk,
    solution_for_conditions,
)
from plotter.wallet.puzzles.puzzle_utils import (
...
from plotter.wallet.secret_key_store import SecretKeyStore
from plotter.wallet.sign_coin_solutions import sign_coin_solutions
...
from plotter.wallet.wallet_info import WalletInfo
...
class Wallet:
    ...
    async def create_spend_bundle_relative_plotter(self, plotter_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if plotter_amount < 0:
            utxos = await self.select_coins(abs(plotter_amount), exclude)
        else:
        ...
        plotter_amount = spend_value + plotter_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": plotter_amount}]
