...
from plotter.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_solutions:
            ...
            if r:
                ...
                if "plotter" in cc_discrepancies:
                    cc_discrepancies["plotter"] = cc_discrepancies["plotter"] + diff
                else:
                    cc_discrepancies["plotter"] = diff
