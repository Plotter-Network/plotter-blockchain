...
from plotter.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "42424"
            testnet_introducer = "beta1_introducer.plotter.network"
            testnet = "testnet0"
            ...
            mainnet_port = "4242"
            mainnet_introducer = "introducer.plotter.network"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running plotter services for changes to take effect")
