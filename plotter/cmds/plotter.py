...
from plotter.cmds.configure import configure_cmd
from plotter.cmds.farm import farm_cmd
from plotter.cmds.init import init_cmd
from plotter.cmds.keys import keys_cmd
from plotter.cmds.netspace import netspace_cmd
from plotter.cmds.plots import plots_cmd
from plotter.cmds.show import show_cmd
from plotter.cmds.start import start_cmd
from plotter.cmds.stop import stop_cmd
from plotter.cmds.wallet import wallet_cmd
...
@click.group(
    help=f"\n  Manage plotter blockchain infrastructure ({__version__})\n",
    epilog="Try 'plotter start node', 'plotter netspace -d 192', or 'plotter show -s'",
...
@cli.command("version", short_help="Show plotter version")
def version_cmd() -> None:
    print(__version__)


@cli.command("run_daemon", short_help="Runs plotter daemon")
@click.pass_context
def run_daemon_cmd(ctx: click.Context) -> None:
    from plotter.daemon.server import async_run_daemon
    import asyncio
