...
from plotter.cmds.init_funcs import check_keys
from plotter.consensus.block_rewards import calculate_base_farmer_reward
from plotter.protocols.protocol_message_types import ProtocolMessageTypes
from plotter.server.outbound_message import NodeType, make_msg
from plotter.simulator.simulator_protocol import FarmNewBlockProtocol
from plotter.types.blockchain_format.coin import Coin
from plotter.types.blockchain_format.sized_bytes import bytes32
from plotter.util.bech32m import decode_puzzle_hash, encode_puzzle_hash
from plotter.util.byte_types import hexstr_to_bytes
from plotter.util.ints import uint32, uint64
from plotter.util.keychain import bytes_to_mnemonic, generate_mnemonic
from plotter.util.path import path_from_root
from plotter.util.ws_message import WsRpcMessage, create_payload_dict
...
from plotter.wallet.util.backup_utils import download_backup, get_backup_info, upload_backup
from plotter.wallet.util.trade_utils import trade_record_to_dict
...
from plotter.wallet.wallet_node import WalletNode
...
class WalletRpcApi:
    def __init__(self, wallet_node: WalletNode):
        ...
        self.service_name = "plotter_wallet"
    ...
    async def _state_changed(self, *args) -> List[WsRpcMessage]:
        ...
        return [create_payload_dict("state_changed", data, "plotter_wallet", "wallet_ui")]
