...
from plotter.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from plotter.harvester.harvester import Harvester
from plotter.plotting.plot_tools import PlotInfo, parse_plot_info
from plotter.protocols import harvester_protocol
from plotter.protocols.farmer_protocol import FarmingInfo
from plotter.protocols.protocol_message_types import ProtocolMessageTypes
from plotter.server.outbound_message import make_msg
...
from plotter.util.api_decorators import api_request, peer_required
from plotter.util.ints import uint8, uint32, uint64
from plotter.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSPlotterConnection
    ):
        """
