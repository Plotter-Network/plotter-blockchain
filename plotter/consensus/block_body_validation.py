...
from plotter.consensus.block_root_validation import validate_block_merkle_roots
...
from plotter.types.name_puzzle_condition import NPC
...
from plotter.util.generator_tools import (
    additions_for_npc,
