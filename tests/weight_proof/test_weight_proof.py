...
from plotter.server.start_full_node import SERVICE_NAME
...
from plotter.consensus.pot_iterations import calculate_iterations_quality
from plotter.full_node.weight_proof import (  # type: ignore
    WeightProofHandler,
