...
from plotter.protocols.full_node_protocol import RespondBlock
from plotter.server.server import PlotterServer
from plotter.simulator.simulator_protocol import FarmNewBlockProtocol, ReorgProtocol
from plotter.types.peer_info import PeerInfo
from plotter.util.ints import uint16, uint32, uint64
...
class TestWalletSimulator:
    ...
    #         outbound: List[WSPlotterConnection] = wallet.server.get_outgoing_connections()
